...
var missingCmd = &cobra.Command{
	...
	PreRunE: func(cmd *cobra.Command, args []string) error {
		if installMissingForce && !installMissing {
...
func init() {
	...
	missingCmd.Flags().BoolVarP(&installMissing, "yes", "y", false, "Auto confirm installations")
